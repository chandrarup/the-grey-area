  ...
  scenes: {
    "s1_emergency_meeting": {
      ...
      props: [
        {
          key: "marcus_salim",
          title: "Marcus — Salim's role & the competition",
          subtitle: "2 pages · read before the call",
          hot: false,
          body: "CEO — short note before we speak.\n\nVictor Salim is the intermediary who can read Ardania's decision environment faster than any of us can from HQ. Meridian is already courting him. He wants a yes/no today on whether GIS will engage him at all. I have kept the commercial terms out of this packet on purpose: I would rather walk the room through them live so we can pressure-test assumptions together.\n\nPlease read David's, Priya's and Tom's notes. The call is not optional theatre — competitor movement means we lose optionality overnight.\n\n— Marcus Reed",
        },
        {
          key: "david_finance",
          title: "David — preliminary financial analysis",
          subtitle: "3 pages · pipeline & margin context",
          hot: false,
          body: "CEO — preliminary view only; not a formal investment memo.\n\nPipeline coverage weakens sharply after eighteen months. Two recent megaprojects returned thinner margins than modelled. Investors are asking clearer growth questions. Ardania, if won, would refill the backlog and shore up utilisation across three regions.\n\nAny intermediary arrangement must be costed, capped, and auditable. I can support speed only where the economics and controls are explicit. I will bring specific questions on structure to the call — please do not treat silence as assent.\n\n— David Okafor, CFO",
        },
        {
          key: "priya_strategy",
          title: "Priya — strategic & stakeholder assessment",
          subtitle: "2 pages · who we become if we win",
          hot: false,
          body: "CEO — strategy & stakeholder scan for this morning's decision.\n\nWinning Ardania would anchor GIS as a preferred infrastructure partner in a fast-modernising market. Losing it after two years of pursuit would also become a story about judgment, not just price.\n\nStakeholders who will judge this choice: employees whose utilisation depends on the next major award; local partners watching whether we buy access or build capability; regulators and NGOs who already remember our prior subcontracting investigation. My question for the room is simple: what exactly would we be purchasing from Salim, and would we be proud to describe it publicly?\n\n— Priya Nair",
        },
        {
          key: "tom_legal",
          title: "Tom — legal & compliance risk",
          subtitle: "4 pages · flags intermediary risk",
          hot: true,
          body: "CEO — compliance risk read before you take Marcus's call.\n\nI have not seen a clean written scope for Salim. Warning signs already visible from what Marcus has shared verbally: a contingent success fee tied to winning a government contract; close government relationships as the claimed value; services defined broadly enough to resist audit; limited transparency on who Salim actually contacts; and intense time pressure that compresses diligence.\n\nNone of that is proof of illegality. Each is a classic red flag in intermediary cases. I need the same questions answered before any promise, retainer, or meeting that looks like engagement.\n\n— Tom Bradley",
        },
      ],
